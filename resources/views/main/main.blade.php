				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
								...
								<div class="col-sm-3">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('product_detail',$np->product_id)}}"><img src="source/image/product/{{$np->image}}" alt=""></a>
										</div>
							...
							<div class ='row text-center' style ="padding-top:20px;">{{$new_prod->links()}}</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('product_detail',$tp->id)}}"><img src="source/image/product/{{$tp->image}}" alt=""></a>
										</div>
										<div class="single-item-body">
